...
export default class Auth {
    ...
    constructor(instance) {
        ...
        this.error_message = config.error_message;
    ...
    getChataboxTokenFromCode(code: string): Promise {
        var params = {
            client_id: this.client_id,
    ...
    getChataboxTokenFromRefreshToken(refreshToken): Promise {
    ...
    getGraphTokenFromCode(code: string): Promise {
        var params = {
            client_id: this.client_id,
            client_secret: this.client_secret,
            code: code,
            ...
            redirect_uri: this.redirect_uri,
            response_mode: 'form_post',
            scope: " User.ReadBasic.All offline_access Contacts.Read Contacts.ReadWrite Directory.Read.All Directory.ReadWrite.All",
            nonce: uuid.v4(),
            state: 'abcd'
        }
    ...
    getGraphTokenFromRefreshToken(refreshToken): Promise {
          console.log ('GETTING GRAPH TOKEN FROM REFRESH');
        ...
        var params = {
            ...
            redirect_uri: this.redirect_uri,
            response_mode: 'form_post',
            scope: " User.ReadBasic.All offline_access Contacts.Read Contacts.ReadWrite",
            nonce: uuid.v4(),
            state: 'abcd'
        }
