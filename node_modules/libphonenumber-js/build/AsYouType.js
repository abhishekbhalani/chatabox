  ...
  _createClass(AsYouType, [{
    ...
    value: function extractNationalPrefix() {
      ...
      if (!this.metadata.possibleLengths() || this.isPossibleNumber(this.nationalNumberDigits) && !this.isPossibleNumber(potentialNationalNumber)) {
        ...
        if ((0, _util.matchesEntirely)(this.nationalNumberDigits, this.metadata.nationalNumberPattern()) && !(0, _util.matchesEntirely)(potentialNationalNumber, this.metadata.nationalNumberPattern())) {
          return;
        }
      }
