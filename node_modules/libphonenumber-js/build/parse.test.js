...
describe('parse', function () {
  ...
  it('should work in edge cases', function () {
    ...
    parseNumber('1111111111111111111', 'US', {
      extended: true
  ...
  it('should extract country calling code from a number', function () {
    (0, _parse_.extractCountryCallingCode)('+78005553535', null, _metadataMin["default"]).should.deep.equal({
      countryCallingCode: '7',
      number: '8005553535'
    });
    (0, _parse_.extractCountryCallingCode)('+7800', null, _metadataMin["default"]).should.deep.equal({
      countryCallingCode: '7',
      number: '800'
    });
    (0, _parse_.extractCountryCallingCode)('', null, _metadataMin["default"]).should.deep.equal({});
  });
});
